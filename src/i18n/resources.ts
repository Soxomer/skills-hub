    ...
    translation: {
      ...
      skillPreview: {
        ...
        errors: {
          ...
          ambiguous:
            'This repository contains several skills and this result could not be matched safely.',
  ...
  zh: {
    translation: {
      ...
      skillPreview: {
        ...
        openAria: '预览 {{name}}',
        close: '关闭预览',
        sourceOpenAria: '在 GitHub 打开 {{source}}',
        sourceOpenFailed: '无法在 GitHub 打开 Skill 源地址',
        loading: '正在加载 Skill 指令...',
        loadingHelp: '正在从源仓库获取 SKILL.md。',
        errorTitle: '无法加载此 Skill',
        retry: '重试',
        readOnly: '仅供预览——尚未安装此 Skill。',
        errors: {
          notFound: '仓库中没有此 Skill 可读取的 SKILL.md。',
          ambiguous: '此仓库包含多个 Skills，无法安全匹配当前结果。',
          tooLarge: '此 SKILL.md 过大，无法安全预览。',
          unsupported: '仅支持预览托管在 GitHub 上的 Explore Skills。',
          generic: '无法加载预览。请检查网络连接后重试。',
        },
      },
