...
const SkillDetailView = ({
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        const result = await invokeLibrary<SkillFileEntry[]>('list_skill_files', {
  ...
  }, [invokeLibrary, skill.central_path, t])
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        const content = await invokeLibrary<string>('read_skill_file', {
          centralPath: skill.central_path,
          filePath: activeFile,
        })
  ...
  }, [activeFile, invokeLibrary, skill.central_path])
  ...
  const sourceValue = locationLabel(skill.source_ref?.trim() || skill.central_path)
